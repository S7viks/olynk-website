          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-white text-xs mb-3">
                "OLynk isn't a dashboard. It's a system. Built to work like your team, just smarter, faster, and always on."
              </p>
              <div className="space-y-1 text-xs">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-white">olynk.aintelligence@gmail.com</span>
                </div>
                <div className="flex items-center space-x-2">
                  <Globe className="h-3 w-3 text-white" />
                  <span className="text-white">olynkai.vercel.app</span>
                </div>
              </div>
            </div>
