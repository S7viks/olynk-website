...
const Features = () => {
  ...
  return (
    <section id="features" className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-gray-900 relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className={`text-center mb-12 sm:mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-6 max-w-4xl mx-auto mx-4">
            <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 font-medium mb-4">
              💡 See the dramatic before/after transformation for each AI capability
            </p>
            <Link
              to="/demo"
              className="inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-4 sm:px-6 py-3 rounded-full font-semibold hover:shadow-xl hover:scale-105 transition-all duration-300 min-h-[44px] text-sm sm:text-base"
              aria-label="Try the interactive demo to see AI capabilities"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`group bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-gray-100 dark:border-gray-700 ${
                  isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                }`}
                style={{ transitionDelay: feature.delay }}
              >
                <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-gradient-to-r ${feature.gradient} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  <Icon className="h-6 w-6 sm:h-7 sm:w-7 text-white" />
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-red-600 dark:group-hover:text-yellow-300 transition-colors duration-300">
                  {feature.title}
                </h3>
                <p className="text-xs sm:text-sm font-semibold text-teal-600 dark:text-teal-400 mb-3">
                  {feature.subtitle}
                </p>
                ...
                <Link
                  to="/demo"
                  className="flex items-center text-teal-600 dark:text-teal-400 font-semibold group-hover:translate-x-2 transition-transform duration-300 text-sm min-h-[44px]"
                  aria-label={`See live demo for ${feature.title}`}
                >
        ...
        {/* Bottom CTA */}
        <div className={`text-center mt-12 sm:mt-16 transition-all duration-1000 delay-1400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="bg-gradient-to-r from-red-50 via-red-25 to-red-50 dark:from-blue-900/30 dark:via-blue-800/20 dark:to-blue-900/30 rounded-2xl p-6 sm:p-8 border border-red-100 dark:border-blue-800/50 mx-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <Link
                to="/demo"
                className="inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-red-600 to-red-700 dark:from-blue-600 dark:to-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:shadow-xl hover:scale-105 transition-all duration-300 min-h-[48px]"
                aria-label="Experience interactive demos"
              >
                <Play className="h-4 w-4 sm:h-5 sm:w-5" />
              ...
              <a
                ...
                className="inline-flex items-center justify-center space-x-2 border-2 border-red-600 dark:border-blue-400 text-red-600 dark:text-blue-400 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-base sm:text-lg hover:bg-red-50 dark:hover:bg-blue-900/20 transition-all duration-300 min-h-[48px]"
